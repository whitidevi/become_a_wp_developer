...
while(have_posts()) {
        the_post();
	pageBanner(); // We can use an array as input argument for more customization:
		      // array( 'title' => 'theTitleValue', 
	 	      //	'subtitle' => 'theSubtitleValue'
		      // 	'photo' => 'https://wallpapercat.com/w/full/8/f/4/914063-1920x1080-desktop-full-hd-library-wallpaper-photo.jpg',)
?>
